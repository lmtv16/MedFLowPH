...
Outputs:
  ...
  results/04/PCA_Cluster/pca_space_pc123_3d_kmeans_numeric.png
                                                          — numeric legend (C0, C1, ...);
                                                            same subsample (max_points=30000)
                                                            and jitter (0.025) as step 03 solid PNG.

Step 06 reads these outputs to assign semantic names and write the labeled PCA scatter
back into results/04/PCA_Cluster/ (pca_space_pc123_3d_kmeans_semantic.png).
