        ...
        <main className="min-w-0 flex-1 space-y-12 overflow-x-hidden pb-16">
          <div className="space-y-12">
            <SectionWrapper id="cleaning-overview">
              ...
              This phase cleans and transforms the PhilGEPS medical-related procurement data, filters relevant 
              records, engineers features, scales numeric values, and encodes categorical variables to create 
              a standardized dataset ready for PCA and clustering. 
            ...
            <SectionWrapper id="cleaning-schema" title="Cleaned Dataset Schema">
              <div className="mb-4 space-y-4 text-mf-body leading-relaxed text-muted-foreground md:text-[1.0625rem] md:leading-relaxed">
                <p>
                After data cleaning, the PhilGEPS medical-related procurement dataset consisted of 487,605 
                records across 61 columns, with no missing values, making it ready for preprocessing.
                </p>
                <p>
                The cleaned schema preserved key procurement, financial, date, location, and supplier fields. 
                High-cardinality text fields were retained for reference and interpretation but were not directly used for clustering.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border bg-card p-5 shadow-sm md:p-6">
                ...
                <div className="mt-5 border-t border-border pt-5">
                  <div className="space-y-4 text-base leading-relaxed text-muted-foreground md:text-lg md:leading-relaxed">
                    <p>
                    Step 01 began with 8,414,861 raw PhilGEPS records and filtered them to isolate medical-related procurement entries.
                     After removing duplicates and applying filtering, the final cleaned dataset contained 487,605 records across 61 columns.
                    </p>
                    <p>
                    The filtering used UNSPSC Description, Item Name, and Item Description to capture 
                    medical-related records even when some classification fields were incomplete. This produced a 
                    focused dataset ready for preprocessing, feature engineering, and clustering.
                    </p>
                  </div>
                </div>
              </div>
